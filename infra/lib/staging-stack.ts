...
export class TriviaMapStagingStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const httpApi = new apigwv2.HttpApi(this, 'HttpApi', { apiName: 'triviamap-stg-api', corsPreflight: { allowOrigins: ['https://stg.triviamap.jp'], allowMethods: [apigwv2.CorsHttpMethod.ANY], allowHeaders: ['Content-Type', 'Authorization', 'X-CSRF-Token'], allowCredentials: true } });
