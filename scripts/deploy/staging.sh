...
REACT_APP_API_BASE_URL="${REACT_APP_API_BASE_URL:-/api}" REACT_APP_SITE_URL="${REACT_APP_SITE_URL:-https://stg.triviamap.jp}" REACT_APP_AD_CLIENT='' REACT_APP_NO_INDEX=true REACT_APP_DISABLE_PWA_METADATA=true npm run build --workspace=@triviamap/front
