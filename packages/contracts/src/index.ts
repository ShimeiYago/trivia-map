...
export const apiInventory = [
  ...
  ['GET', '/articles/mine'], ['POST', '/articles'], ['PUT', '/articles/:postId'], ['PATCH', '/articles/:postId'], ['DELETE', '/articles/:postId'], ['GET', '/likes/mine'], ['POST', '/likes/toggle/:postId'], ['GET', '/likes/check/:postId'], ['GET', '/special-map/maps/my-previews'], ['POST', '/special-map/maps'], ['PUT', '/special-map/maps/:mapId'], ['PATCH', '/special-map/maps/:mapId'], ['DELETE', '/special-map/maps/:mapId'], ['POST', '/special-map/maps/:mapId/post-marker'], ['GET', '/special-map/markers/:markerId'], ['PUT', '/special-map/markers/:markerId'], ['PATCH', '/special-map/markers/:markerId'], ['DELETE', '/special-map/markers/:markerId'],
  ['GET', '/auths/csrf/'], ['POST', '/auths/registration/'], ['POST', '/auths/registration/verify-email/'], ['POST', '/auths/registration/resend-email/'], ['POST', '/auths/login/'], ['POST', '/auths/logout/'], ['GET', '/auths/user/'], ['PUT', '/auths/user/update/'], ['PATCH', '/auths/user/update/'], ['POST', '/auths/password/change/'], ['POST', '/auths/password/reset/'], ['POST', '/auths/password/reset/confirm/'], ['POST', '/auths/token/refresh/'], ['POST', '/auths/token/verify/'], ['PUT', '/auths/deactivate/'], ['POST', '/auths/twitter/request-token'], ['POST', '/auths/twitter/access-token'], ['POST', '/auths/twitter/login'],
] as const;
