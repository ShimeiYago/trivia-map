...
: "${REACT_APP_API_BASE_URL:?Set the staging API URL}"

REACT_APP_API_BASE_URL="$REACT_APP_API_BASE_URL" REACT_APP_NO_INDEX=true npm run build --workspace=@triviamap/front
